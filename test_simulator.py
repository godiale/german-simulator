...
class TestSimulator(unittest.TestCase):
    ...
    def test_fails_weight_func(self):
        ...
        self.assertEqual(1, fails_weight_func({'tries': [0]}, 3))
        self.assertEqual(4, fails_weight_func({'tries': [0, 0]}, 3))
        self.assertEqual(9, fails_weight_func({'tries': [0, 0, 0]}, 3))
        self.assertEqual(0, fails_weight_func({'tries': [1]}, 3), 0)
        self.assertEqual(1, fails_weight_func({'tries': [1, 0]}, 3), 1)
        self.assertEqual(4, fails_weight_func({'tries': [1, 0, 0]}, 3), 4)
        self.assertEqual(0, fails_weight_func({'tries': [1, 1]}, 3), 0)
        self.assertEqual(1, fails_weight_func({'tries': [1, 1, 0]}, 3), 1)
        self.assertEqual(0, fails_weight_func({'tries': [1, 1, 1]}, 3), 0)
        self.assertEqual(0, fails_weight_func({'tries': [0, 1, 1, 1]}, 3))
        self.assertEqual(1, fails_weight_func({'tries': [0, 0, 1, 1]}, 3))
        self.assertEqual(1, fails_weight_func({'tries': [0, 1, 0, 1]}, 3))
        self.assertEqual(1, fails_weight_func({'tries': [0, 1, 1, 0]}, 3))
        self.assertEqual(0, fails_weight_func({'tries': [1, 1, 1, 1]}, 3))
        self.assertEqual(1, fails_weight_func({'tries': [1, 0, 1, 1]}, 3))
        self.assertEqual(1, fails_weight_func({'tries': [1, 1, 0, 1]}, 3))
        self.assertEqual(1, fails_weight_func({'tries': [1, 1, 1, 0]}, 3))
